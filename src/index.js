...
app.use('/api/v1/orderdetails', verifyToken, orderdetailRoutes(new OrderDetailController()));
app.use('/api/v1/orders', verifyToken, orderRoutes(new OrderController()));
app.use('/api/v1/cart', verifyToken, cartRoutes(new CartController()));
